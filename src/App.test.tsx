...
describe("wedding photo lightbox", () => {
  ...
  it("shows the trusted payment details after a successful four-entry submission", async () => {
    const fetchMock = vi.fn()
      .mockResolvedValueOnce({ ok: true, json: async () => publicStatus })
      .mockResolvedValueOnce({ ok: true, json: async () => ({ ok: true, entryCount: 4, amountDue: 35 }) });
    ...
    expect(container.textContent).toContain("Thanks, Avery. You’re almost in.");
